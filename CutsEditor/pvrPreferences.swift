...
/// per pvr preferences
public struct pvrPreferences: Codable
{
...
//  init?(data: NSData)
//  {
//    if let coding = NSKeyedUnarchiver.unarchiveObject(with: data as Data) as? PVREncoding
//    {
...
//
//  func encode() -> NSData {
//    return NSKeyedArchiver.archivedData(withRootObject: PVREncoding(self)) as NSData
//  }
//
//  @objc(_TtCV10EnigmaEdit14pvrPreferencesP33_D998D5A43C73D75DC59144BD8C00DBC811PVREncoding)private class PVREncoding: NSObject, NSCoding
//  {
//    let title : String
//    let cutReplace : Int
